    ...
    <>
      {loading ? (
        ...
        <>
          ...
          <MinCategory />
          <main className="mt-12 sm:mt-0 didbjjer">
            {/* <!-- product image & description container --> */}
            <div className="w-full flex flex-col sm:flex-row bg-white sm:p-2 relative productDetailspajds">
              {/* <!-- image wrapper --> */}
              <div className="w-full sm:w-2/5 sm:sticky top-16 sm:h-screen">
                ...
                <div className="flex flex-col gap-3 m-3">
                  ...
                  <div className="w-full flex gap-3">
                    ...
                    <button
                      style={{ background: "rgb(115, 62, 52)" }}
                      onClick={buyNow}
              ...
              <div className="flex-1 py-2 px-3">
                ...
                <div className="flex flex-col gap-2 mb-4">
                  ...
                  <span className="text-sm text-gray-500 font-medium flex gap-2 items-center">
                    <span className="text-xs px-1.5 py-0.5 bg-primary-green rounded-sm text-white flex items-center gap-0.5 msihsdhu344">
